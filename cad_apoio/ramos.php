...
?>
	...
	<meta name="description" content="Cadastro de Ramos">
	...
	<script>
    var retorno = carga_ramos(1);
  </script>
	<script language="javascript" src="../js/ramos.js"></script>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
      					<button type="button" class="btn btn-sm btn-incluir" onclick="javascript:inclui_Ramo();"> 
                        <i class="fas fa-plus" aria-hidden="true"></i> Incluir 
                        </button>
                    </li>
                    <li class="nav-item">
      					&nbsp;<button type="button" class="btn btn-sm btn-consultar" onclick="javascript:carga_ramos(1);"> 
