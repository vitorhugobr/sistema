...
if (liberado(5750)==0){
	...
	$_SESSION['funcao']="Cadastro de Exames";
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br">
  ...
  <meta name="description" content="Cadastro de Exames">
  ...
  <script>
    var retorno = carga_exames(1);
  </script>
  <script language="javascript" src="../js/exames.js"></script>
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="carga_exames(1)" onBlur="carga_exames(1)" onFocus="carga_exames(1)">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
      					<button type="button" class="btn btn-sm btn-incluir" onclick="javascript:inclui_exame();"> 
                        <i class="fas fa-plus" aria-hidden="true"></i> Incluir 
                        </button>
                    </li>
                    <li class="nav-item">
      					&nbsp;<button type="button" class="btn btn-sm btn-success" onclick="javascript:carga_exames(1);"> 
...
?>
    ...
    <tr>
        ...
        <td width="40%" valign="top"><div class="edicao" id="edicao"></div></td>
      </tr>
  </table>
  </form>
<?php
