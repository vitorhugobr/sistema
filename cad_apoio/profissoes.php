...
?>
	...
	<meta name="description" content="Cadastro de Profissões">
	...
	<script>
    var retorno = carga_profissoes(1);
  </script>
	<script language="javascript" src="../js/profissoes.js"></script>
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="carga_profissoes(1)" onBlur="carga_profissoes(1)" onFocus="carga_profissoes(1)">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
      					<button type="button" class="btn btn-sm btn-incluir" onclick="javascript:inclui_Profissao();"> 
                        <i class="fas fa-plus" aria-hidden="true"></i> Incluir 
                        </button>
                    </li>
                    <li class="nav-item">
      					&nbsp;<button type="button" class="btn btn-sm btn-consultar" onclick="javascript:carga_profissoes(1);"> 
