...
while ($dados_s = $mysql_query->fetch_assoc()) {
	...
	$displayEnc .=  '</div></td>
	<td>
		<button type="button" class="btn btn-sm btn-excluir" onClick="javascript:exclui_duplo('.$dados_s["CODIGO"].','.$dados_s["NOME"].')"><i class="fas fa-trash" aria-hidden="true"></i> Excluir Duplo</button>
	</td></tr>';
}
