<?php 
# Emissão deste relaório é especifico para DR THIAGO pois o mesmo não tem cpanel disponível #
session_start();
...
if ($qtd_emails== 0){
	...
	if ($qtd_emails== 1){
		$mens_qtde = $iniciohtml.'01 aniversariante em '.$hoje.' conforme abaixo:<br><br>'.$pessoas.'</body></html>';
	}else{
		$mens_qtde = $iniciohtml.'Existem '.$qtd_emails.' aniversariantes em '.$hoje.' conforme abaixo:<br><br>'.$pessoas.'</body></html>';
	}
