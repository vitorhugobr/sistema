...
echo $mens_qtde = "Já se passaram $intervalo->y anos, $intervalo->m meses, $intervalo->d dias, $intervalo->h horas desde minha demissão da COBRAV. Totalizando $intervalo->days dias";
